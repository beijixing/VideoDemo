...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    [Canceller sharedCanceller].shouldCancel = YES;
}
...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    [Canceller sharedCanceller].shouldCancel = NO;
    [[NSNotificationCenter defaultCenter] postNotificationName:@"replayMovie" object:nil];
}
